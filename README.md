...
Dashboard interno de ChangeLog de TI. Puxa dados do Movidesk e do Monday, gera um Excel por Sprint e exibe tudo em um painel HTML para a intranet.
...
A sincronização roda automaticamente a cada 15 dias.